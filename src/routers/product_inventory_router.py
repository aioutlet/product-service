...
from src.controllers.product_controller import get_product_by_id, get_all_products
from src.services.inventory_client import get_inventory_client, InventoryItem
from src.models.product_db import ProductDB
...
async def get_products_with_inventory(
    ...
    try:
        ...
        products = await get_all_products(db["products"], limit, skip, category, active_only)
        ...
        for product in products:
            ...
            enriched_products.append(ProductWithInventory(
                id=product.id,
                name=product.name,
                description=product.description,
                price=product.price,
